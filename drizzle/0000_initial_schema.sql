...
--> statement-breakpoint
CREATE INDEX `papers_user_id_idx` ON `papers` (`user_id`,`deleted_at`,`created_at`);
--> statement-breakpoint
CREATE INDEX `papers_status_idx` ON `papers` (`status`,`deleted_at`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `paper_results_paper_id_idx` ON `paper_results` (`paper_id`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `credit_transactions_user_id_idx` ON `credit_transactions` (`user_id`,`created_at`);
