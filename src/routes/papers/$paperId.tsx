...
export const Route = createFileRoute("/papers/$paperId")({
  ...
  loader: async ({ context, params }) => {
    ...
    return { paper: data.paper, ssrMeta: null };
  },
  head: ({ loaderData }) => {
    ...
    const description = `Visual whiteboard summary of "${ssrMeta.title}" — generated by PicX AI.`;
    ...
    meta.push({
      property: "og:url",
      content: `${SITE_ORIGIN}/papers/${ssrMeta.paperId}`,
    });
