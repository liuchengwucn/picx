...
export function ShareBanner({ paperId, isPublic, canShare }: ShareBannerProps) {
          ...
          <div className="relative flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
              <div className="flex items-center gap-2 rounded-lg border border-[var(--line)] bg-[var(--parchment)] px-3 py-2">
                ...
                <span className="text-xs font-mono text-[var(--ink-soft)] truncate max-w-[200px]">
                  {shareUrl}
                </span>
              </div>
